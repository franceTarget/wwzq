...
import com.ren.wwzq.web.handler.PrincipalHandshakeHandler;
import com.ren.wwzq.web.WsDecoratorFactory;
import com.ren.wwzq.web.interceptor.WsChannelInterceptor;
import com.ren.wwzq.web.interceptor.WsHandshakeInterceptor;
...
public class WebSocketStompConfig implements WebSocketMessageBrokerConfigurer {
    ...
    @Autowired
    private WsDecoratorFactory wsDecoratorFactory;
    @Autowired
    ...
    public void configureWebSocketTransport(WebSocketTransportRegistration registration) {
        ...
        registration.addDecoratorFactory(wsDecoratorFactory);
    }
    ...
    // 返回false,不会添加消息转换器，返回true，会添加默认的消息转换器，
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        /*
         * spring 内置broker对象
         * 1. 配置代理域，可以配置多个，此段代码配置代理目的地的前缀为 /topic 或者 /user
         *    我们就可以在配置的域上向客户端推送消息
        ...
        /*
         *  "/app" 为配置应用服务器的地址前缀，表示所有以/ws-msg 开头的客户端消息或请求
         *  都会路由到带有@MessageMapping 注解的方法中
         */
        registry.setApplicationDestinationPrefixes("/ws-msg");
